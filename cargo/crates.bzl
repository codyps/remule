...
def raze_fetch_remote_crates():
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.async-attributes-1.1.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.async-global-executor-2.0.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.async-lock-2.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.async-process-1.3.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.async-std-1.10.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__atoi__0_4_0",
        url = "https://crates.io/api/v1/crates/atoi/0.4.0/download",
        type = "tar.gz",
        sha256 = "616896e05fc0e2649463a93a15183c6a16bf03413a7af88ef1285ddedfa9cda5",
        strip_prefix = "atoi-0.4.0",
        build_file = Label("//cargo/remote:BUILD.atoi-0.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.blocking-1.1.0.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__crc__2_1_0",
        url = "https://crates.io/api/v1/crates/crc/2.1.0/download",
        type = "tar.gz",
        sha256 = "49fc9a695bca7f35f5f4c15cddc84415f66a74ea78eef08e90c5024f2b540e23",
        strip_prefix = "crc-2.1.0",
        build_file = Label("//cargo/remote:BUILD.crc-2.1.0.bazel"),
    )

    maybe(
        http_archive,
        name = "raze__crc_catalog__1_1_1",
        url = "https://crates.io/api/v1/crates/crc-catalog/1.1.1/download",
        type = "tar.gz",
        sha256 = "ccaeedb56da03b09f598226e25e80088cb4cd25f316e6e4df7d695f0feeb1403",
        strip_prefix = "crc-catalog-1.1.1",
        build_file = Label("//cargo/remote:BUILD.crc-catalog-1.1.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.crossbeam-queue-0.3.2.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__enum_primitive_derive__0_2_2",
        url = "https://crates.io/api/v1/crates/enum-primitive-derive/0.2.2/download",
        type = "tar.gz",
        sha256 = "c375b9c5eadb68d0a6efee2999fef292f45854c3444c86f09d8ab086ba942b0e",
        strip_prefix = "enum-primitive-derive-0.2.2",
        build_file = Label("//cargo/remote:BUILD.enum-primitive-derive-0.2.2.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.fmt-extra-0.2.1.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__futures_intrusive__0_4_0",
        url = "https://crates.io/api/v1/crates/futures-intrusive/0.4.0/download",
        type = "tar.gz",
        sha256 = "62007592ac46aa7c2b6416f7deb9a8a8f63a01e0f1d6e1787d5630170db2b63e",
        strip_prefix = "futures-intrusive-0.4.0",
        build_file = Label("//cargo/remote:BUILD.futures-intrusive-0.4.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.gloo-timers-0.2.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.kv-log-macro-1.0.7.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.plain-0.2.3.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__serde_json__1_0_70",
        url = "https://crates.io/api/v1/crates/serde_json/1.0.70/download",
        type = "tar.gz",
        sha256 = "e277c495ac6cd1a01a58d0a0c574568b4d1ddf14f59965c6a58b8d96400b54f3",
        strip_prefix = "serde_json-1.0.70",
        build_file = Label("//cargo/remote:BUILD.serde_json-1.0.70.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.signal-hook-0.3.10.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__sqlformat__0_1_8",
        url = "https://crates.io/api/v1/crates/sqlformat/0.1.8/download",
        type = "tar.gz",
        sha256 = "b4b7922be017ee70900be125523f38bdd644f4f06a1b16e8fa5a8ee8c34bffd4",
        strip_prefix = "sqlformat-0.1.8",
        build_file = Label("//cargo/remote:BUILD.sqlformat-0.1.8.bazel"),
    )

    maybe(
        http_archive,
        name = "raze__sqlx__0_5_9",
        url = "https://crates.io/api/v1/crates/sqlx/0.5.9/download",
        type = "tar.gz",
        sha256 = "7911b0031a0247af40095838002999c7a52fba29d9739e93326e71a5a1bc9d43",
        strip_prefix = "sqlx-0.5.9",
        build_file = Label("//cargo/remote:BUILD.sqlx-0.5.9.bazel"),
    )

    maybe(
        http_archive,
        name = "raze__sqlx_core__0_5_9",
        url = "https://crates.io/api/v1/crates/sqlx-core/0.5.9/download",
        type = "tar.gz",
        sha256 = "aec89bfaca8f7737439bad16d52b07f1ccd0730520d3bf6ae9d069fe4b641fb1",
        strip_prefix = "sqlx-core-0.5.9",
        build_file = Label("//cargo/remote:BUILD.sqlx-core-0.5.9.bazel"),
    )

    maybe(
        http_archive,
        name = "raze__sqlx_macros__0_5_9",
        url = "https://crates.io/api/v1/crates/sqlx-macros/0.5.9/download",
        type = "tar.gz",
        sha256 = "584866c833511b1a152e87a7ee20dee2739746f60c858b3c5209150bc4b466f5",
        strip_prefix = "sqlx-macros-0.5.9",
        build_file = Label("//cargo/remote:BUILD.sqlx-macros-0.5.9.bazel"),
    )

    maybe(
        http_archive,
        name = "raze__sqlx_rt__0_5_9",
        url = "https://crates.io/api/v1/crates/sqlx-rt/0.5.9/download",
        type = "tar.gz",
        sha256 = "0d1bd069de53442e7a320f525a6d4deb8bb0621ac7a55f7eccbc2b58b57f43d0",
        strip_prefix = "sqlx-rt-0.5.9",
        build_file = Label("//cargo/remote:BUILD.sqlx-rt-0.5.9.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.structopt-0.3.25.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.tokio-1.13.0.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.tokio-macros-1.5.1.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//cargo/remote:BUILD.value-bag-1.0.0-alpha.8.bazel"),
    )
    ...
    maybe(
        http_archive,
        name = "raze__whoami__1_2_0",
        url = "https://crates.io/api/v1/crates/whoami/1.2.0/download",
        type = "tar.gz",
        sha256 = "c33ac5ee236a4efbf2c98967e12c6cc0c51d93a744159a52957ba206ae6ef5f7",
        strip_prefix = "whoami-1.2.0",
        build_file = Label("//cargo/remote:BUILD.whoami-1.2.0.bazel"),
    )
